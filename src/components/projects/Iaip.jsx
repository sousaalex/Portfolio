...
import MentorIALogo from "../../../public/image/iaip.png";
import { FaReact } from "react-icons/fa";
import { IoLogoJavascript } from "react-icons/io5";
import { RiTailwindCssFill } from "react-icons/ri";

export default function Iaip() {
  return (
    <div className="flex-shrink-0 w-full sm:w-1/3 lg:w-1/4 shadow-md shadow-gray-500">
      <div className="group relative overflow-hidden rounded-lg shadow-lg">
        ...
        <div className="absolute inset-0 bg-fiber-carbon px-4 py-3 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
          <h3 className="text-xl font-bold text-white">IAIP 19th Conference</h3>
          ...
          <div className="mt-3 flex gap-3">
            <a
              target="_blanc"
              href="https://iaip.vercel.app/home"
            ...
            <a
              target="_blanc"
              href="https://github.com/sousaalex/IAIP"
